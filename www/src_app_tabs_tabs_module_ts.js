...
const routes = [
    {
        ...
        children: [
            {
                path: 'hiit',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_hiit_hiit_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ../hiit/hiit.module */ 7854)).then((m) => m.HiitPageModule),
            },
            {
                path: 'timer',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_timer_timer_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ../timer/timer.module */ 9178)).then((m) => m.TimerPageModule),
            },
            {
                path: '',
